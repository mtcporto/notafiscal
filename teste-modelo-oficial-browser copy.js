...
async function assinarModeloOficial(xml) {
    try {
        ...
        // USAR A MESMA LÓGICA DO FLUXO NORMAL QUE ESTÁ FUNCIONANDO
        // Usar certificado carregado via processarCertificado (node-forge)
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" 
    ...
    <soap:Body>
        ...
        // Para o teste modelo oficial, usar método direto sem popup
        console.log('📡 Teste modelo oficial - usando método direto sem popup...');
